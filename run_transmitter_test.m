...
hold on;
xline(fc_A, 'r--', 'LineWidth', 2, 'Label', 'Carrier');
xline(fc_A-240, 'g--', 'LineWidth', 1, 'Label', '-240 Hz');
xline(fc_A+240, 'g--', 'LineWidth', 1, 'Label', '+240 Hz');
xlabel('Frequency (Hz)');
ylabel('PSD (dB/Hz)');
...
hold on;
xline(fc_B, 'r--', 'LineWidth', 2, 'Label', 'Carrier');
xline(fc_B-240, 'g--', 'LineWidth', 1, 'Label', '-240 Hz');
xline(fc_B+240, 'g--', 'LineWidth', 1, 'Label', '+240 Hz');
xlabel('Frequency (Hz)');
ylabel('PSD (dB/Hz)');
title('Power Spectral Density');
